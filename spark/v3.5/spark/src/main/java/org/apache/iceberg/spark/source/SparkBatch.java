...
import org.apache.iceberg.spark.ImmutableLanceBatchReadConf;
import org.apache.iceberg.spark.OrcBatchReadConf;
import org.apache.iceberg.spark.ParquetBatchReadConf;
import org.apache.iceberg.spark.ParquetReaderType;
import org.apache.iceberg.spark.SparkReadConf;
import org.apache.iceberg.spark.SparkUtil;
import org.apache.iceberg.spark.LanceBatchReadConf;
...
class SparkBatch implements Batch {
  ...
  public PartitionReaderFactory createReaderFactory() {
    ...
    } else if (useLanceBatchReads()) {
      return new SparkColumnarReaderFactory(lanceBatchReadConf());
    } else {
  ...
  private LanceBatchReadConf lanceBatchReadConf() {
    return ImmutableLanceBatchReadConf.builder().batchSize(readConf.parquetBatchSize()).build();
  }
  ...
  private boolean useLanceBatchReads() {
    return true;
  }
